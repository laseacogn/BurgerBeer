...
import voucherData from "../../data/usedVoucher.json";
  ...
  return (
    ...
    <div className="w-full ml-[20px] gap-4 justify-center items-center">
          {voucher.map((voucherItem, index) => (
            ...
            >
              <img
                src={require(`../../assets/image/voucher/4.jpeg`)}
                alt=""
              ...
              <div style={{ position: "absolute", zIndex: "3" }}>
                <p className="font-sans font-bold text-[17px] text-gray-600 ml-[165px] mt-[-122px]">
                  {" "}
                  {voucherItem.title}
                </p>
              ...
              <div style={{ position: "absolute", zIndex: "5" }}>
                <p className="font-sans font-semibold text-[12px] text-white ml-[13px] mt-[-123px]">
                   Used
                </p>
                </div>
            </div>
