...
import voucherData from "../../data/expiredVoucher.json";
          ...
          {voucher.map((voucherItem, index) => (
            ...
            >
              ...
              <div style={{ position: "absolute", zIndex: "4" }}>
                <p className="font-sans font-semibold text-[11px] text-red-600 ml-[520px] mt-[-137px]">
                  {" "}
                  x{voucherItem.quantity - voucherItem.quantityUsed}
                </p>
              </div>
              <div style={{ position: "absolute", zIndex: "5" }}>
                <p className="font-sans font-semibold text-[12px] text-white ml-[12px] mt-[-140px]">
                    Expried
                </p>
                </div>
            </div>
