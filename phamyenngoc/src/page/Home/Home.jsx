      ...
      <div className="max-w-[1200px] mx-auto ">
        ...
        >
          ...
          >
            ...
            <div style={{
              ...
              }}> A restaurant in 31 An Thuong 4, Da Nang, specializing in burgers, sandwiches, hotdogs, pizza, and fried, is proudly family-owned and centrally situated in the heart of the city.
              </p>
            </div>
            <div style={{
              width: '190px',
        ...
        <div style={{ width: '1200px', left: '158px', paddingTop: '30px', filter: 'drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25))' }}>
          ...
          <div className='mb-4 w-[960px] h-[200px] relative bg-[#066515cf] mt-40 rounded-2xl translate-x-60'>
            <div>
              ...
              <p style={{
                ...
                textAlign: 'center',
                color: '#FFFFFF',
              }}> Their first foray into burgers started 10 years ago. Now, the two Burger Bros are teaming up to bring 100% Angus beef burgers, shakes, wings, and fries to their community. Because when hunger strikes, there’s nothing like a good old-fashioned burger!
              </p>
          ...
          <div className='mb-4 w-[960px] h-[200px] relative bg-[#b81a1acf] rounded-2xl mt-36'>
            <div>
              <p className="absolute w-960 h-200 left-245 top--53 font-inter font-bold text-22 leading-39 flex items-center justify-center text-center text-white">  OUR HAPPY CUSTOMERS
              </p>
              <p className="absolute w-778 left-7 top-72 font-inter font-extralight italic  text-20 leading-29 flex items-center justify-center text-center text-white"> Have been there several times now. I am always impressed with the service and food quality. All of the employees are young but they are professional and do a great job. I have never had a bad meal there. Great burger and sandwiches.
              </p>
