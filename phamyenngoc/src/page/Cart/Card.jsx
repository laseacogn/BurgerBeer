...
const Card = () => {
 ...
 const validateCardNumber = (number) => {
  ...
  const isButtonActive = validateCardNumber(cardNumber) && validateReleaseDate(releaseDate) && validateNameOnCard(nameOnCard);
  return (
    <div className="max-w-[1200px] mx-auto">
      <div class="w-full mt-[10px] pb-[20px] bg-[#FFFEFE] shadow-md rounded-lg">
        ...
        <div className="w-[96%] mx-auto mt-[20px] flex justify-between items-center">
          <div className="w-[700px] h-[515px]  overflow-x-auto bg-[#FEFFFF] shadow-xl">
            <Tabs aria-label="Tabs with underline" style="underline">
              <Tabs.Item
                active
                title={
                  <p className="w-[315px] text-center font-sans text-[18px] font-bold">
                    ATM Card
                  </p>
                }
              >
                <img
                  className="w-[250px] mt-[10px] ml-[225px]"
                  src={require("../../assets/image/avatar/vcb.jpg")}
                  alt=""
                />
                <div className="w-[600px] ml-[50px] mt-[20px]">
                  <div className="mb-2 block">
                    <Label
                      htmlFor="email"
                      value="Card number"
                      className="font-sans font-semibold text-[17px] text-gray-900"
                    />
                  </div>
                  <TextInput
                    id="email"
                    type="email"
                    placeholder="Enter card number (ex: 9704 36** ****)"
                    required
                    value={cardNumber}
                    onChange={(e) => setCardNumber(e.target.value)}
                  ></TextInput>
                </div>
                <div className="w-[600px] ml-[50px] mt-[15px] flex">
                  ...
                  <div className="w-[420px] ml-[30px]">
                    ...
                    <TextInput
                      id="email"
                      type="email"
                      placeholder="Enter the name on the card (no accents)"
                      required
                      value={nameOnCard}
                  ...
                  <Button
                  color={isButtonActive ? "green" : "gray"}
                  className={`w-[240px] rounded-none mt-[20px] ml-[410px] ${isButtonActive ? 'bg-green-600' : 'bg-gray-200'}`}
                  disabled={!isButtonActive}
                >
                  <div className={`flex font-sans font-semibold text-[17px] ${isButtonActive ? 'text-white' : 'text-gray-500'}`}>
                    <RiSecurePaymentLine className="w-[20px] h-[20px]" />
                    <p className="ml-[5px]">
                      Payment 250,000 VND
                    </p>
                  </div>
            ...
            <div className="w-full flex justify-center items-center mt-[40px]">
              ...
              <img
                className="w-[100px] h-[35px] mt-[-20px] mr-[10px]"
                src={require("../../assets/image/avatar/vcb2.jpg")}
                alt=""
              />
          ...
          <div className="w-[420px] h-[500px] mx-auto">
